...
export default function RequestPage() {
  ...
  const getPendingReq =  () => {
    ...
    axios.get('http://localhost:5000/api/admin/getPendingReq')
  ...
  useEffect(() => {
   getPendingReq();
    ...
    const acceptReq = ()=>{
      ...
      try{
        axios.post('http://localhost:5000/api/admin/getPendingReq',{id})
        .then((response)=>{
          console.log(response)
          getPendingReq();
          setOpen(null)
    ...
    const getReason =(reason)=>{
      ...
      if(reason){
        ...
        const id = sessionStorage.getItem('selectId')
        try{
          axios.post('http://localhost:5000/api/admin/rejectReq',{id,reason})
          .then((response)=>{
            console.log(response)
            getPendingReq();
            setOpen(null)
